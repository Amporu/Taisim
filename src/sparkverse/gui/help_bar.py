...
class HelpBar():
    ...
    def showpannel(frame,image,x,y,rotation,accel):
        ...
        cv2.putText(img=image,text="X = "+str(x),org=(30,450),fontFace=HelpBar.font,fontScale=0.5,color=(0,0,0),thickness=2)#pylint: disable=E1101
        cv2.putText(img=image,text="Y = "+str(y),org=(130,450),fontFace=HelpBar.font,fontScale=0.5,color=(0,0,0),thickness=2)#pylint: disable=E1101
