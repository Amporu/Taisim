...
class VirtualSensor:
    ...
    def __init__(self,win,xval,yval,clock,flag,fps,track,angle):
        ...
        SensorBar.sensor_key.append(str(self.sensor_count))
...
class Camera(VirtualSensor):
    ...
    # Find the top-left and bottom-left points
        ...
        if (top_right[0]<20 or top_right[0]>630 or
            top_right[1]<20 or top_right[1]>470 or
            top_left[0]<20 or top_left[0]>630 or
            top_left[1]<20 or top_left[1]>470):
            self.player.bounce_back()
        if (bottom_right[0]<20 or bottom_right[0]>630 or
            bottom_right[1]<20 or bottom_right[1]>470 or
            bottom_left[0]<20 or bottom_left[0]>630 or
            bottom_left[1]<20 or bottom_left[1]>470):
            self.player.bounce_forward()
        try:
        ...
        cv2.rectangle(Utils.mask,(tl_rect_x,tl_rect_y),(br_rect_x,br_rect_y),(255,0,255),1)
        ...
        M = cv2.getRotationMatrix2D(center, -(self.angle+angle), 1.0)
