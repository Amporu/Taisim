...
class HelpBar():
    ...
    def showpannel(frame,image,x_pos,y_pos,rotation,accel):
        ...
        cv2.putText(img=image,text="HelpBar",org=(12, 20),fontFace=HelpBar.font,fontScale=0.8,color=(9,0,0),thickness=2)#pylint: disable=E1101
        for i in range(len(HelpBar.keys)):# pylint: disable=C0200
            if HelpBar.last_key==i:
                if i!=2:
                    ...
                    cv2.putText(img=image,text=HelpBar.keys[i],org=(20,50+i*40),fontFace=HelpBar.font,fontScale=0.5,color=(0,255,0),thickness=2)#pylint: disable=E1101
                ...
                if i!=2 or Video.recorded!=-1 or Video.recorded==0:
                    ...
                    cv2.putText(img=image,text=HelpBar.keys[i],org=(20,50+i*40),fontFace=HelpBar.font,fontScale=0.5,color=(0,0,255),thickness=2)#pylint: disable=E1101
                    cv2.putText(img=image,text=HelpBar.description[i],org=(50,50+i*40),fontFace=HelpBar.font,fontScale=0.5,color=(0,0,255),thickness=2)#pylint: disable=E1101
        ...
        cv2.putText(img=image,text="X = "+str(x_pos),org=(30,450),fontFace=HelpBar.font,fontScale=0.5,color=(0,0,0),thickness=2)#pylint: disable=E1101
        cv2.putText(img=image,text="Y = "+str(y_pos),org=(130,450),fontFace=HelpBar.font,fontScale=0.5,color=(0,0,0),thickness=2)#pylint: disable=E1101
        cv2.putText(img=image,text="Angular Movement",org=(30,470),fontFace=HelpBar.font,fontScale=0.5,color=(255,0,0),thickness=2)#pylint: disable=E1101
        cv2.putText(img=image,text="angle = "+str(rotation),org=(30,490),fontFace=HelpBar.font,fontScale=0.5,color=(0,0,0),thickness=2)#pylint: disable=E1101
        cv2.putText(img=image,text="Linear Movement",org=(30,510),fontFace=HelpBar.font,fontScale=0.5,color=(255,0,0),thickness=2) #pylint: disable=E1101
        cv2.putText(img=image,text="speed = "+str(round(accel,2)),org=(30,530),fontFace=HelpBar.font,fontScale=0.5,color=(0,0,0),thickness=2)#pylint: disable=E1101
